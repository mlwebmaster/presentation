(() => {
    ...
    (() => {
        ...
        da.init();
        const rangeSlider = document.getElementById("range-slider"), input0 = document.getElementById("input0"), input1 = document.getElementById("input1");
        const rangeSlider2 = document.getElementById("range-slider2"), input3 = document.getElementById("input3"), input4 = document.getElementById("input4");
